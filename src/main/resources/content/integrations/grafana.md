...
![Install JSON Grafana Plugin](/site/images/integrations/grafana/install-plugin.png)

### Step 2 — Add a New Datasource

1. Go to **Connections → Data sources → Add data source**

   ![Click Add new data source](/site/images/integrations/grafana/add-datasource.png)
...
2. Select **JSON** and configure the following fields:
   ...
   ![Configure h5m JSON Datasource](/site/images/integrations/grafana/configure-datasource.png)

3. Click **Save & Test**

   ![Datasource connected successfully](/site/images/integrations/grafana/datasource-success.png)
...
![Create new Dashboard](/site/images/integrations/grafana/create-dashboard.png)
...
1. Add a panel and select **h5m** as the datasource
   ...
   ![Select h5m Datasource](/site/images/integrations/grafana/select-datasource.png)

2. Give the panel a name

   ![Set panel name](/site/images/integrations/grafana/panel-name.png)
...
3. Set the query path using your folder and node IDs:
   ...
   ![Define query path](/site/images/integrations/grafana/path.png)

4. Add the appropriate fields in the **Fields** section

   ![Configure fields in Grafana](/site/images/integrations/grafana/fields-grafana.png)

5. Save the panel

   ![Save panel](/site/images/integrations/grafana/save-panel.png)

   ![Dashboard with h5m data](/site/images/integrations/grafana/dashboard.png)
