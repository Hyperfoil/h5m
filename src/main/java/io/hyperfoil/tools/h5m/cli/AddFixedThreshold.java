...
public class AddFixedThreshold implements Callable<Integer> {
    ...
    @CommandLine.Option(names = {"inclusive"}, arity = "0..1", description = "whether boundary values are within range", defaultValue = "true")
    boolean inclusive;
