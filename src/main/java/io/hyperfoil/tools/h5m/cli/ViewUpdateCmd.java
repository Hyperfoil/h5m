...
public class ViewUpdateCmd implements Command<H5mCommandInvocation>, FolderAware {
    ...
    @Argument(description = "view name", required = true, completer = ViewNameCompleter.class)
    String viewName;
