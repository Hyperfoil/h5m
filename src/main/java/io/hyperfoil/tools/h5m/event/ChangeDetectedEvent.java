 ...
 * @param nodeType     the type of detection node
 ...
 */
public record ChangeDetectedEvent(long folderId, long nodeId, String nodeName, NodeType nodeType,
                                   List<Long> valueIds, boolean dispatch, long rootValueId) {}
