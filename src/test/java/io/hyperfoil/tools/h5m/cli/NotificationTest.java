...
public class NotificationTest {
    ...
    public void add_with_raw_data_json() {
        List<String> results = H5mTest.run(aeshLauncher,
                ...
                "cd raw_json_test",
                "notification add WEBHOOK --data '{\"method\":\"WEBHOOK\",\"url\":\"https://raw.example.com/hook\"}'",
                "notification list",
                "cd .."
        );
    ...
    public void add_rejects_invalid_config() {
        List<String> results = H5mTest.run(aeshLauncher,
                new CommandResult[]{CommandResult.SUCCESS, CommandResult.SUCCESS,
                        CommandResult.USAGE_ERROR, CommandResult.SUCCESS, CommandResult.SUCCESS},
                "folder add invalid_config_test",
                "cd invalid_config_test",
                "notification add WEBHOOK --data '{\"method\":\"WEBHOOK\",\"url\":\"\"}'",
                "notification list",
                "cd .."
        );
